...
export const MOCK_COMMUNITIES = [
  {
    ...
    defaultRoomProvider: 'nostrnests',
...
export const MOCK_CHANNELS = {
  'n72:sifaka-builders': [
    ...
    {
      id: 'ch:builders:lounge',
      communityId: 'n72:sifaka-builders',
      category: 'Rooms',
      name: 'lounge',
      topic: 'Drop in for live voice hangs between streams.',
      channelType: 'voice',
      privacyLevel: 'public',
      slowModeSec: 0,
      archived: false,
      ...
      roomNaddr: 'naddr1qq9xjmnfw35k7mfeqgs6rv',
      roomStatus: 'live',
      roomHostPubkey: 'pub_alice',
      roomCurrentParticipants: 6,
      roomTotalParticipants: 18,
      roomSpeakers: ['pub_alice', 'pub_mod'],
      roomParticipants: ['pub_alice', 'pub_mod', 'pub_craig', 'pub_guest'],
      roleOverrides: []
    },
    {
      id: 'ch:builders:screen-share',
      communityId: 'n72:sifaka-builders',
      category: 'Rooms',
      name: 'screen-share',
      topic: 'Video room for demos, pair sessions, and co-working.',
      channelType: 'video',
      privacyLevel: 'public',
      slowModeSec: 0,
      archived: false,
      pinned: false,
      roomProvider: 'hivetalk',
      roomId: 'builders-screen-share',
      roomStatus: 'planned',
      roomHostPubkey: 'pub_craig',
      roomStartsAt: now + 30 * min,
      roleOverrides: []
    }
  ],
  'n29:ops-room': [
